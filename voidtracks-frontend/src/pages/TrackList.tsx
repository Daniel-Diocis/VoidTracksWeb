...
function TrackList() {
    ...
    fetch(`${API_URL}/tracks`)
        ...
        const aggiornati = data.map(track => {
            const id = track.music_path; // o track.id se preferisci
            ...
            if (shouldUpdate) {
            // Potresti fare qualcosa, ad esempio mostrare un badge "NUOVO"
        ...
        // Salva i nuovi timestamp aggiornati
    ...
    return (
        ...
        <h1 className="text-2xl font-bold mb-4 text-center flex items-center justify-center gap-2">
            <img
            src={icon}
            alt="Icona VoidTracks"
            className="h-[1em] w-[1em] object-contain align-middle inline"
            />
            VoidTracks
        </h1>
