 ...
 */
router.get("/", playlistController_1.listUserPlaylists);
/**
 ...
 */
router.get("/:id", playlistMiddleware_1.checkPlaylistOwnership, playlistController_1.getPlaylistWithTracks);
/**
 ...
 */
router.delete("/:id", playlistMiddleware_1.checkPlaylistOwnership, playlistController_1.deletePlaylist);
/**
 ...
 */
router.patch("/:id", playlistMiddleware_1.checkPlaylistOwnership, playlistController_1.renamePlaylist);
/**
 ...
 */
router.post("/:id/tracks", playlistMiddleware_1.checkPlaylistOwnership, playlistMiddleware_1.checkTrackIdInBody, playlistMiddleware_1.checkTrackOwnership, playlistMiddleware_1.checkTrackNotInPlaylist, playlistController_1.addTrackToPlaylist);
/**
 ...
 */
router.delete("/:id/tracks/:trackId", playlistMiddleware_1.checkPlaylistOwnership, playlistMiddleware_1.checkTrackIdParam, playlistController_1.removeTrackFromPlaylist);
/**
 ...
 */
router.patch("/:id/favorite", playlistMiddleware_1.checkPlaylistOwnership, playlistMiddleware_1.checkTrackIdInFavoriteBody, playlistController_1.setFavoriteTrack);
